...
int endcolor=-14986554;
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("219110__zyrytsounds__evil-laugh.wav"));
